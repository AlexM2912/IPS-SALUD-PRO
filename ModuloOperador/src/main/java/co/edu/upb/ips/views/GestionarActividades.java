...
public class GestionarActividades extends JFrame {
    ...
    public GestionarActividades() {
        ...
        JButton boton3 = new JButton("Ordenes Médicas");
       ...
       // Crear ActionListener para el botón de Ordenes Médicas
        boton3.addActionListener(e -> {
            // Abrir la vista de GestionarOrden
            GestionarOrden gestionarOrden = new GestionarOrden();
            gestionarOrden.setVisible(true);
            dispose(); // Cerrar la ventana actual
        });

        // Crear ActionListener para el botón de Registro y Control
        boton2.addActionListener(e -> {
            // Abrir la vista de GestionarRegistro
            GestionarRegistro gestionarRegistro = new GestionarRegistro();
            gestionarRegistro.setVisible(true);
            dispose(); // Cerrar la ventana actual
        });
