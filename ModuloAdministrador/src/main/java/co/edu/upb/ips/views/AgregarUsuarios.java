...
public class AgregarUsuarios extends JFrame{
    ...
    public AgregarUsuarios() {
        ...
        JLabel subtitulo = new JLabel("Por favor, seleccione el tipo de usuario que desea agregar");
        ...
        String path23 = "C:/Users/alexd.MONTAÑEZ/IdeaProjects/IPS-SALUD-PRO/ModuloAdministrador/src/main/java/co/edu/upb/ips/images/img_1.png";
        ImageIcon icon23 = new ImageIcon(path23);
        JLabel logolabel23 = new JLabel(icon23);
        logolabel23.setBounds(355, 345, 150, 150);
        panel.add(logolabel23);

        String path4 = "C:/Users/alexd.MONTAÑEZ/IdeaProjects/IPS-SALUD-PRO/ModuloAdministrador/src/main/java/co/edu/upb/ips/images/img_1.png";
        ImageIcon icon4 = new ImageIcon(path4);
        JLabel logolabel4 = new JLabel(icon4);
        logolabel4.setBounds(640, 345, 150, 150);
        panel.add(logolabel4);

        String path5 = "C:/Users/alexd.MONTAÑEZ/IdeaProjects/IPS-SALUD-PRO/ModuloAdministrador/src/main/java/co/edu/upb/ips/images/img_1.png";
        ImageIcon icon5 = new ImageIcon(path5);
        JLabel logolabel5 = new JLabel(icon5);
        logolabel5.setBounds(930, 345, 150, 150);
        ...
        // Crear ActionListener para el botón de Medicos
        boton2.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Abrir la vista de AgregarMedicos
                AgregarMedicos agregarMedicos = new AgregarMedicos();
                agregarMedicos.setVisible(true);
                dispose(); // Cerrar la ventana actual
            }
        });
