...
public class EliminarUsuarios extends JFrame {
    ...
    public EliminarUsuarios() {
        ...
        JLabel titulo = new JLabel("Eliminar Usuarios");
        ...
        JLabel subtitulo = new JLabel("Por favor seleccione el tipo de usuario que desea eliminar");
        ...
        boton2.addActionListener(e -> {
            // Abrir la vista de EliminarMedicos
            EliminarMedicos eliminarMedicos = new EliminarMedicos();
            eliminarMedicos.setVisible(true);
            dispose(); // Cerrar la ventana actual
        });
